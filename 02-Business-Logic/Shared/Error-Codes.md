...
# ⚙️ Business Logic: Error Code Registry (Diagnostic Guide)

ไฟล์นี้จัดทำขึ้นเพื่อให้ AI Agent ใช้ในการวินิจฉัยปัญหา (Diagnosis) เมื่อเกิดข้อผิดพลาดจากระบบ Order-Service
...
## 🛠️ วิธีการวินิจฉัยสำหรับ AI Agent
