...
description: จุดเริ่มต้นสำหรับ Flow onboarding, suitability, KYC review retake, re-KYC, KYC expiry และ account suspension
capability: Customer
services: [onboarding-service]
aliases: [customer onboarding, suitability, KYC retake, retake-re-kyc, re-KYC, KYC expiry, onboarding reminder, reminder email, เปิดบัญชี, ถ่ายบัตรใหม่, แบบประเมินความเสี่ยง, ทบทวน KYC, อีเมลเตือนเปิดบัญชี]
status: active
